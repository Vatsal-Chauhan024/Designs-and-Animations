...
const PopupExample = () => {
    ...
    return (
        ...
        <div className='h-screen w-screen flex items-center justify-center'>
            <button className='bg-red-500 text-white px-4 h-7 rounded-sm' onClick={handleOpen} >Click Me</button>


            <Popup open= {open}  contentStyle={{width: contentWidth, height:contentHeight , padding: '12px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', borderRadius: '10px' }}>
