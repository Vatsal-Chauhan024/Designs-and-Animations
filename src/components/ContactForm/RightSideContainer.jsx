...
const RightSideContainer = () => {
  ...
  return (
   ...
   <p className='font-thin text-gray-500 text-justify text-sm w-5/6'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Architecto exercitationem vitae sint doloribus consequuntur neque repellendus ipsa hic nulla asperiores quasi possimus eveniet.</p>
